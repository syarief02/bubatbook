...
export default function ViewAsBanner() {
  ...
  const statusLabel =
    viewAs.role === 'group_admin' && viewAs.fleetStatus ? ` (${viewAs.fleetStatus})` : '';
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r ${bgColor} backdrop-blur-md shadow-lg`}
    >
